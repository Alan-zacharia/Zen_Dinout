...
const RecentRestaurants : React.FC<RecentUsersProps> = ({restaurants}) => {
  return (
    ...
    <div className="mt-3">
      <div className="relative overflow-x-auto">
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
          {restaurants && restaurants.length > 0 &&  restaurants.map((restaurant , index : number)=>(
...
export default  React.memo(RecentRestaurants);
