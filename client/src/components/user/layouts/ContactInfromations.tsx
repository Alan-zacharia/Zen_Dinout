...
const ContactInfromations: React.FC<ContactInfromationsProps> = ({
  ...
  return (
    <section className="max-h-auto  bg-white rounded-xl shadow-lg hidden xl:flex flex-col">
      <div className="w-[350px] 2xl:w-[400px] p-5 flex flex-col">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col  justify-center pt-10 gap-5">
            <div>
              ...
              <p className="text-black font-semibold xl:text-base cursor-pointer flex gap-2 items-center">
            ...
            <div className="mt-10 flex flex-col gap-5">
              <p className="text-blue-500 font-semibold xl:text-sm 2xl:text-lg  underline cursor-pointer flex gap-2 items-center">
