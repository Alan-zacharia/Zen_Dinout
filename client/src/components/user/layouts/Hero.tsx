...
// interface HeroProps {
//   handleSearch: (query: string, minPrice?: number, maxPrice?: number) => void;
...
//     handleSearch(e.target.value, minRate, maxRate);
//   };
...
//     searchItem || minRate !== undefined || maxRate !== undefined;
...
//               )}
//               {isFilterVisible && (
//                 <div className="bg-white shadow-lg shadow-black w-[115px] pt-4 flex text-center justify-center absolute right-0 top-full mt-2 pb-5">
//                   <ul className="flex flex-col text-base text-black cursor-pointer">
//                     <li className="border-b pt-3 pb-3">Filter by rate</li>
//                     <li
